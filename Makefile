...
gpu: gpu_bandwidth_rw gpu_latency gpu_bandwidth_transfers gpu_latency_internal gpu_bandwidth_internal
...
gpu_bandwidth_internal: src/gpu_bandwidth_internal.c
	$(CC) $(CFLAGS) -o gpu_bandwidth_internal src/gpu_bandwidth_internal.c
